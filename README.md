# Minesweeper
<p>Привет! Я начинающий разработчик и&nbsp;Minesweeper это моя игра: это старый добрый сапёр но написан на c++ с библиотекой SDL3 то есть производительный. Также игра оптимизирована но имеет баги т.к сделана за день. Игра будет обновляться и баги будут исправляться. Спасибо за внимание!</p>
